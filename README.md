...
rMD17 benzene（C₆H₆, 12 原子）上已完成 uncertainty branch Round 000–003（4 rounds, 4 committee models per round）。
...
| `rmd17_benzene/random_baseline` | 已完成 | benzene random baseline (seed0/1/2 Round 001–003) |
...
rMD17 benzene 数据集 (C₆H₆, 12 atoms):
  ↓
