...
- 三种 active 策略 Force RMSE 差异在 1σ 内（0.354–0.362 eV/Å），均显著优于 random
...
> 在 rMD17 ethanol 单体系实验中，uncertainty / diversity / trust_level 三种 active 策略的 Force RMSE 差异在 1σ 内（0.354–0.362 eV/Å），均显著优于 random baseline（0.607 ± 0.683 eV/Å）。这与 toy H2 四策略结论一致。多体系验证仍待完成。
