...
4. toy H2 和 rMD17 ethanol 上 diversity 和 trust-level 均已完成 multi-seed multi-round 验证；
...
```text
rMD17 ethanol: diversity + trust_level baselines (done: four-strategy comparison complete)
  ↓
