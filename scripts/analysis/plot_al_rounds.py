...
ROOT = Path("/data/zft")
csv_path = ROOT / "experiments/al_rounds_summary.csv"
...
def main():
    ...
    make_svg(
        out_dir / "force_model_deviation_rounds.svg",
        "Force model deviation over active learning rounds",
        "Active learning round",
        "Top-K force model deviation",
        rounds,
        [
            ("Mean", force_dev_mean),
            ("Max", force_dev_max),
    ...
    make_svg(
        out_dir / "dataset_size_rounds.svg",
    ...
    make_svg(
        out_dir / "validation_rmse_rounds.svg",
        "Validation errors over active learning rounds",
        "Active learning round",
        "Mean RMSE",
        rounds,
        [
            ("Force RMSE", force_rmse_mean),
